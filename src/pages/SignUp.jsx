    ...
    <div className="flex p-4 items-center justify-center min-h-screen">
      ...
      >
        <fieldset className="p-4 border rounded-md border-gray-300">
          ...
          <label className="mt-3 label">Photo URL</label>
          <input
            type="text"
            name="photoURL"
          ...
          <div className="my-4 gap-3 flex items-center justify-center">
            <div className="w-16 bg-gray-400 h-px"></div>
          ...
          <button
            ...
            className="transition rounded-md p-3 flex w-full gap-3 items-center justify-center bg-green-300 hover:bg-green-400 font-bold"
          >
            <img
